...
/**
 * Class to test the Greeting class. STUDENTS, you can assume the methods in
 * this class are correct.
 * However, since Greeting isn't created by default, we have commented out all
 * of these methods. You
 * should uncomment them as you work through building the Greeting class.
 *
 * You are also free to add your own tests! Just providing the unit tests this
 * time, so you can
 * focus on java syntax more than testing for HW01. Future homeworks, you will
...
public class GreetingTest {
    ...
    public void testGetUnicodeGreeting() {
        ...
        assertEquals("你好", china.getUnicodeGreeting()); // only changes for this one,
    }
    ...
    public void testToString() {
        assertEquals("{localityID:2, localityName:\"USA\", asciiGreeting:\"Hello\", unicodeGreeting:\"Hello\"}",
                usa.toString());
        assertEquals("{localityID:1, localityName:\"Hawaii\", asciiGreeting:\"Aloha\", unicodeGreeting:\"Aloha\"}",
                hawaii.toString());
        assertEquals("{localityID:3, localityName:\"China\", asciiGreeting:\"Ni Hao\", unicodeGreeting:\"你好\"}",
                china.toString());
    }

    /**
     * Tests to make sure the format string is formatted properly to generate a
     * greeting.
     */
    @Test
    public void testGreet() {
        ...
        assertEquals("John, Ni Hao!", String.format(china.getFormatStr(true),
                "John"));
    }
